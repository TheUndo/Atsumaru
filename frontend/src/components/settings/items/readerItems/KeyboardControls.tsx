            ...
            <Setting label="Keyboard controls" desktop dropdown>
                <Button
                    ...
                    icon={
                        <RadioCircle
                            checkbox
                            active={
                                settings.readerKeyboardNavigation?.disabled ===
                                "YES"
                            }
                        />
                    }
                    ...
                    icon={
                        <RadioCircle
                            ...
                            active={
                                settings.readerKeyboardNavigation?.disabled ===
                                    "NO" &&
                                settings.readerKeyboardNavigation?.wasd ===
                                    "YES"
                            }
                        />
                    }
                    ...
                    icon={
                        <RadioCircle
                            ...
                            active={
                                settings.readerKeyboardNavigation?.disabled ===
                                    "NO" &&
                                settings.readerKeyboardNavigation?.arrowKeys ===
                                    "YES"
                            }
                        />
                    }
                    ...
                    icon={
                        <RadioCircle
                            ...
                            active={
                                settings.readerKeyboardNavigation?.disabled ===
                                    "NO" &&
                                settings.readerKeyboardNavigation?.nextPage ===
                                    "YES"
                            }
                        />
                    }
                ...
                <Button
                    ...
                    icon={
                        <RadioCircle
                            ...
                            active={
                                settings.readerKeyboardNavigation?.disabled ===
                                    "NO" &&
                                settings.readerKeyboardNavigation
                                    ?.previousPage === "YES"
                            }
                        />
                    }
                    onClick={() =>
                        setSetting?.(
                            ...
                            settings.readerKeyboardNavigation?.previousPage ===
                                "YES"
                                ? "NO"
                                : "YES"
                        )
                ...
                <Button
                    ...
                    onClick={() => {
                        ...
                        setSetting?.(
                            "readerKeyboardNavigation.spacebar",
                            toSet
                        );
                    }}
                    css={{
