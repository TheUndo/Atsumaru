        ...
        {settings.readerBackgroundColor === "custom" && (
          <div className={classes.colorPicker}>
            ...
            <input
              ...
              onChange={(e) => {
                clearTimeout((window as any).__settingsDebounceColor);
                (window as any).__settingsDebounceColor = setTimeout(() => {
                  setSetting("readerCustomBackgroundColor", e.target.value);
                }, 10);
              }}
            />
          </div>
